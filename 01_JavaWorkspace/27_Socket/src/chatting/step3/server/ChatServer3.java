...
class ChatThread extends Thread{
	...
	BufferedReader br;
	PrintWriter pw;
	ChatServer3 chatServer3; // Thread에서 Process에 Method를 쓰려면 그냥 통쨰로 가져온다.
	...
	ChatThread (Socket s, ChatServer3 chatServer3) {
		...
		chatServer3.broadcast(s.getInetAddress()+"(님)이 채팅방에 들어오셨습니다.");
	...
	public void run() {
		...
		try {
			...
			chatServer3.broadcast(s.getInetAddress() +"(님)이 채팅방을 나가셨습니다");
